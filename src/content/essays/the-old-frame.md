...
code themselves. The replies agree:

> We will lose the craft; we are the last bastion of these skills.
...
When a transformative technology arrives, it is measured from the
perspective of the historical methodology. The pattern is older than
any single example.
...
technophobes; many were expert operators of the machines they later
...
that the Web would not amount to much:
